...
from django.contrib.auth import views as auth_views ##Vistas

###Siempre se tiene que poner el as a view para que lo muestre como una vista
urlpatterns = [
    path('', Home.as_view(), name='home'),
    ##Vista de logeo con django
